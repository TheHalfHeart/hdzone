 ...
 */
require_once ROOT_CKFINDER . "core/connector/php/constants.php";
...
$GLOBALS['connector'] =& CKFinder_Connector_Core_Factory::getInstance("Core_Connector");

if(isset($_GET['command'])) {
    $GLOBALS['connector']->executeCommand($_GET['command']);
}
else {
    $GLOBALS['connector']->handleInvalidCommand();
}
