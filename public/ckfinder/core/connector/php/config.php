...
function CheckAuthentication()
{
	...
	return (defined('CAN_USE_CKFINDER') && CAN_USE_CKFINDER);
}
...
*/
$config['HtmlExtensions'] = array('html', 'htm', 'xml', 'js', 'css', 'json');
...
foreach ($plugins as $key => $val){
    if ($val){
        include_once ROOT_CKFINDER . "plugins/".$key."/plugin.php";
    }
}

$config['plugin_imageresize'] = $imageSize;
