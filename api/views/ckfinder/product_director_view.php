    ...
    <body class="CKFinderFrameWindow">
        ...
        //<![CDATA[
            (function()
            {
                ...
                config.language = 'en';
                config.startupPath = '<?php echo $this->input->get('type') ?>:/<?php echo $this->input->get('start'); ?>/';
                config.connectorPath = '<?php echo $this->config->base_url('api.php/ckfinder/product_director/connector/'.$id.'/'.$this->input->get('type')); ?>';
