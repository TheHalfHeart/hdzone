...
{ 
	public function index()
	{
            ...
            if ($this->security->is_action('post_edit'))
            {
                ...
                if (!$current_post = $this->product_post_model->canEditPost($post_id)){
                    die ('101');
                }
                ...
                $data = array(
                    ...
                    'post_price'     => trim((string)$this->input->post('post_price')),
                    'post_star'     => trim((string)$this->input->post('post_star')),
                    ...
                    'post_ref_brand_id'     => trim((int)$this->input->post('post_ref_brand_id')),
                    'post_ref_manu_id'      => trim((int)$this->input->post('post_ref_manu_id')),
                ...
                $check = $this->product_post_model->edit($data, $post_id, $current_post);
            ...
            $form = $this->load->widget('product/post_edit', array($data));
