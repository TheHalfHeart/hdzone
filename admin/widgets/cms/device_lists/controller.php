...
class Cms_device_lists_widget extends MY_Widget 
{ 
    public function index()
    {
        ...
        $this->pagination->setTotalRecord($this->cms_device_model->countList($filter));
        $this->pagination->setLimit($filter['limit']);
        $this->pagination->setLink('cms/device_lists');
        ...
        // List Data
        $data = $this->cms_device_model->getList($filter);
