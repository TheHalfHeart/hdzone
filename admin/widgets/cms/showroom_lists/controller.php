...
class Cms_showroom_lists_widget extends MY_Widget 
{ 
    public function index()
    {
        ...
        $this->pagination->setTotalRecord($this->cms_showroom_model->countList($filter));
        $this->pagination->setLimit($filter['limit']);
        $this->pagination->setLink('cms/showroom_lists');
        ...
        // List Data
        $data = $this->cms_showroom_model->getList($filter);
