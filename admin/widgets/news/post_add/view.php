...
<div class="box">
    <div class="heading">
        <h1><img alt="" src="public/admin/image/home.png">Thêm Tin Tức Mới</h1>
        <div class="buttons">
...
<script language="javscript" type="text/javascript">
    ...
    {
        // Title Page
        jsAdmin.changeTitle('Thêm Tin Tức Mới');
        ...
        $('#click-save').click(function()
        {
            ...
            jsAdmin.sendAjax('post', 'text', data, 'news/post_add', function (result)
            {
                result = trim(result);
                ...
                if (result == '101'){
                    ...
                    jsAdmin.redirect('news/post_edit?post_id='+result);
                }
                else{
