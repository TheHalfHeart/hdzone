 ...
 */
class News_post_lists_widget extends MY_Widget 
{ 
    public function index()
    {
        ...
        $this->pagination->setTotalRecord($this->news_post_model->countList($filter));
        ...
        $this->pagination->setLink('news/post_lists');
        ...
        $filter['select'] = 'post_id,'.lang_field('post_title').','.lang_field('post_ref_cate_title_short').',post_add_user_username,post_timer_date_time_int,editting_date_time_int,editting_user_username,editting_token,post_ref_cate_id';
        
        // List Data
        $data = $this->news_post_model->getList($filter);
