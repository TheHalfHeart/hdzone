...
<div class="box">
    <div class="heading">
        <h1><img alt="" src="public/admin/image/home.png">Thêm Tác Giả</h1>
        <div class="buttons">
    ...
    <div class="content">
        ...
        <form id="form" onsubmit=" return false;" method="post">
                ...
                <table class="form">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="multilang" type="text" id="author_seo_main_keyword" name="author_seo_main_keyword" value="<?php _lang_val($filter, 'author_seo_main_keyword'); ?>" maxlength="255" size="100"></div>
            ...
            <?php $this->security->set_action('author_add'); ?>
        </form>
    </div>
</div>
...
<script language="javscript" type="text/javascript">
    ...
    {
        jsAdmin.changeTitle('Thêm Tác Giả Phim Mới');
        ...
        $('#click-save').click(function()
        {
            ...
            jsAdmin.sendAjax('post', 'text', data, 'product/author_add', function (result)
            {
                result = trim(result);
                if (result == '100'){
