...
<div class="box">
    <div class="heading">
        <h1><img alt="" src="public/admin/image/home.png">Thêm Ổ Đĩa</h1>
        <div class="buttons">
    ...
    <div class="content">
        ...
        <form id="form" onsubmit=" return false;" method="post">
                        ...
                        <tr>
                            ...
                            <td>
                                <select id="hdd_status">
                                    ...
                                    <option value="1" <?php if (isset($filter['hdd_status']) && $filter['hdd_status'] == 1) echo 'selected'; ?>>Đã đầy</option>
                                </select>
            ...
            <?php $this->security->set_action('hdd_add'); ?>
        </form>
    </div>
</div>
...
<script language="javscript" type="text/javascript">
    ...
    {
        jsAdmin.changeTitle('Thêm Ổ Đĩa Mới');
        ...
        $('#click-save').click(function()
        {
            ...
            jsAdmin.sendAjax('post', 'text', data, 'product/hdd_add', function (result)
            {
                result = trim(result);
                if (result == '100'){
