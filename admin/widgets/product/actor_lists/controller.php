...
class Product_actor_lists_widget extends MY_Widget 
{ 
    public function index()
    {
        ...
        $filter = array
        (
            lang_field('actor_title_short') => $this->input->get('actor_title_short'),
        ...
        $this->pagination->setTotalRecord($this->product_actor_model->countList($filter));
        $this->pagination->setLimit($filter['limit']);
        $this->pagination->setLink('product/actor_lists');
        ...
        // List Data
        $data = $this->product_actor_model->getList($filter);
