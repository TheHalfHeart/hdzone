...
class CI_User_agent {
	...
	{
		if (defined('ENVIRONMENT') AND is_file('./system/application/config/'.ENVIRONMENT.'/user_agents.php'))
		{
			include('./system/application/config/'.ENVIRONMENT.'/user_agents.php');
		}
		elseif (is_file('./system/application/config/user_agents.php'))
		{
			include('./system/application/config/user_agents.php');
		}
		else
		{
			return FALSE;
