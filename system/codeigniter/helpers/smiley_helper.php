...
if ( ! function_exists('_get_smiley_array'))
{
	...
	{
		if (defined('ENVIRONMENT') AND file_exists('./system/application/config/'.ENVIRONMENT.'/smileys.php'))
		{
		    include('./system/application/config/'.ENVIRONMENT.'/smileys.php');
		}
		elseif (file_exists('./system/application/config/smileys.php'))
		{
			include('./system/application/config/smileys.php');
		}
